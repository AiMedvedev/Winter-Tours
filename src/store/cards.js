const cards = {
	state: {
		cards: [{
				...
				text: `Преимущество этого путешествия: отметим Новый год в теплой
			...
			},
			{
				...
				text: `Водопад и береговая батарея Подъём в 08:00. Завтрак в 09:00. Выход
			...
			},
			{
				...
				text: `Первый день акклиматизации. Выход к водопаду «Девичьи Косы» и к
			...
			},
			{
				...
				text: `Встреча группы. Экскурсия по Бахчисараю. Празднование Нового года
			...
			},
			{
				...
				text: `Мурманск, охота за северным сиянием (с сентября по апрель) Завтрак
