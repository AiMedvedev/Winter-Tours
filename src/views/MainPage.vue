      ...
      <div class="grid d-flex justify-content-between flex-wrap">
        <a href="single.html">
          <div class="item-wrapper d-flex flex-column mb-4">
            <img src="../src/img/mount.jpeg" class="mb-3" alt="" />
        ...
        <a href="single.html">
          <div class="item-wrapper d-flex flex-column">
            <img src="../src/img/elbrus.jpeg" class="mb-3" alt="" />
        ...
        <a href="single.html">
          <div class="item-wrapper d-flex flex-column">
            <img src="../src/img/crimea.jpeg" class="mb-3" alt="" />
        ...
        <a href="single.html">
          <div class="item-wrapper d-flex flex-column">
            <img src="../src/img/polar.jpg" class="mb-3" alt="" />
        ...
        <a href="single.html">
          <div class="item-wrapper d-flex flex-column">
            <img src="../src/img/altay.jpg" class="mb-3" alt="" />
            <h2>Зимний Алтай</h2>
            <div class="description">
